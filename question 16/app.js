...
var guest = ["Ali", "suhana", "bilal", "sumaira"];
console.log(guest);
var changeGuest = "sumaira";
...
guest.map(function (items) { return console.log("Dear! ".concat(items, " You are invited for dinner")); });
